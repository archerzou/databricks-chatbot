      ...
      <ChatContent data-testid="chat-content">
        <WelcomeContainer visible={!hasMessages} data-testid="welcome-container">
          ...
          <SuggestionButtons data-testid="suggestion-buttons">
            <SuggestionButton data-testid="suggestion-button" onClick={() => handleSuggestionClick("Explain housing risk")}>
              <SuggestionIcon />
              <span>Explain housing risk</span>
            </SuggestionButton>
            <SuggestionButton data-testid="suggestion-button" onClick={() => handleSuggestionClick("FOC abbr. in Healthcare")}>
              <SuggestionIcon />
              <span>FOC abbr. in Healthcare</span>
            </SuggestionButton>
            <SuggestionButton data-testid="suggestion-button" onClick={() => handleSuggestionClick("Improve my notes")}>
              <SuggestionIcon />
              <span>Improve my notes</span>
            </SuggestionButton>
            <SuggestionButton onClick={() => handleSuggestionClick("What does DHB mean?")}>
              <SuggestionIcon />
              <span>What does DHB mean?</span>
            </SuggestionButton>
          </SuggestionButtons>
